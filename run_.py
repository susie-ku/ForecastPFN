...
#             'history': history, 
#             'real_size': history, 
#             'train': f'{PATH}/ETT-small/ETTh1_.csv', 
#             'borders': None, 
#             'max_size': 500,
#             'flag': 'supervised'
#         }
...
#             'history': history, 
#             'real_size': history, 
#             'train': f'{PATH}/ETT-small/ETTh2_.csv', 
#             'borders': None, 
#             'max_size': 500,
#             'flag': 'supervised'
#         }
...
#             'history': history, 
#             'real_size': history, 
#             'train': f'{PATH}/ETT-small/ETTm1_.csv', 
#             'borders': None, 
#             'max_size': 500,
#             'flag': 'supervised'
#         }
...
#             'history': history, 
#             'real_size': history, 
#             'train': f'{PATH}/ETT-small/ETTm2_.csv', 
#             'borders': None, 
#             'max_size': 500,
#             'flag': 'supervised'
#         }
...
#             'flag': 'supervised'
#         }
#     histories = [101] # [336, 672, 1344, 2688, 5376, 10752, 21504, 43008]
#     for history in histories:       
#         config[f'Traffic_{horizon}_{history}'] = {
#             'horizon': horizon, 
#             'history': history, 
